  ...
  return (
    <div className="min-h-screen text-white py-20" style={{ backgroundColor: '#111' }}>
      <div className="container mx-auto px-6">
        {/* Header */}
        <div {...getAnimationClasses(0)} className="text-center mb-16">
        ...
        <div {...getAnimationClasses(200)} className="mb-16">
        ...
        <div {...getAnimationClasses(400)} className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto mb-16">
        ...
        <div {...getAnimationClasses(600)} className="max-w-5xl mx-auto">
          <h2 {...getAnimationClasses(600)} className="text-3xl font-semibold text-center mb-8">Vantagens da Computação Quântica</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {vantagens.map((vantagem, index) => {
              ...
              return (
                <div 
                  key={index}
                  {...getAnimationClasses(700 + index * 100)} // Atraso individual para cada vantagem
          ...
          {/* Exemplo prático */}
          <div {...getAnimationClasses(1100)} className="bg-transparent rounded-lg p-8 border border-purple-500/30 transition-all duration-300 hover:border-purple-500/60 hover:shadow-lg hover:shadow-purple-500/20">
